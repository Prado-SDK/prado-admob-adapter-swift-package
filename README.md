# Prado AdMob Adapter SDK

Prado iOS AdMob Adapter SDK for Swift Package Manager.
...
```swift
dependencies: [
    .package(url: "https://github.com/Prado-SDK/admob-adapter-swift-package.git", "2.0.0"..<"2.1.0")
]
```
